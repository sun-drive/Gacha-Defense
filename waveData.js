...
window.WAVE_DATA = {
    ...
    25: ['boss', 'boss', 'healer', 'tank', 'speedy', 'map_special'], // 25웨이브 듀얼 보스전
    ...
    30: ['boss', 'boss', 'aggro', 'healer', 'tank', 'tank', 'speedy'], // 30웨이브 정예 보스전
    ...
    35: ['boss', 'boss', 'boss', 'healer', 'healer', 'tank', 'tank', 'map_special'], // 35웨이브 트리플 보스전
    ...
    40: ['boss', 'boss', 'boss', 'aggro', 'aggro', 'healer', 'healer', 'tank', 'tank'], // 40웨이브 보스군 강림
    ...
    45: ['boss', 'boss', 'boss', 'boss', 'healer', 'healer', 'healer', 'tank', 'tank', 'tank'], // 45웨이브 쿼드러플 보스전
