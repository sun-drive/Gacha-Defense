document.addEventListener('DOMContentLoaded', () => {
    ...
    class FreezerTower extends BaseTower {
        attack() {
            ...
            enemies.forEach(enemy => {
                ...
                const distance = Math.sqrt(Math.pow(this.x - enemy.x, 2) + Math.pow(this.y - enemy.y, 2));
                if (distance <= this.stats.range) {
                    // Only apply freeze if enemy is NOT already slowed AND NOT resistant
                    if (!enemy.slowed && !enemy.isSlowResistant) { // Added check for !enemy.slowed
                        // Apply a strong slow/freeze effect
                        enemy.slowed = true;
                        enemy.slowTimer = 180; // Freeze for 3 seconds (60fps * 3)
                        enemy.appliedSlowFactor = 0; // 100% stop
                        // Apply slow resistance immediately after freezing
    ...
    class Projectile {
        constructor(x, y, target, damage, sourceTower = null, options = {}) {
            this.x = x;
            this.y = y;
            this.target = target;
            this.damage = damage;
    ...
    const waves = [
        ...
        ['tank', 'tank', 'tank', 'tank', 'regenerator', 'regenerator', 'aggro', 'aggro'], // 24
        ['speedy', 'speedy', 'speedy', 'splitter', 'splitter', 'splitter', 'burning', 'burning'], // 25
        ...
        // Wave 30+ adjusted for more enemies
        ['tank', 'tank', 'tank', 'tank', 'speedy', 'speedy', 'speedy', 'speedy', 'basic', 'basic', 'basic', 'basic'], // 30 (12)
        ['superspeed', 'superspeed', 'basic', 'basic', 'speedy', 'speedy', 'superspeed', 'superspeed', 'basic', 'basic', 'speedy', 'speedy'], // 31 (12)
        ['heavytank', 'heavytank', 'tank', 'tank', 'basic', 'basic', 'heavytank', 'heavytank', 'tank', 'tank', 'basic', 'basic'], // 32 (12)
        ['superspeed', 'superspeed', 'burning', 'burning', 'superspeed', 'superspeed', 'burning', 'burning', 'superspeed', 'superspeed', 'burning', 'burning'], // 33 (12)
        ['heavytank', 'heavytank', 'regenerator', 'regenerator', 'heavytank', 'heavytank', 'regenerator', 'regenerator', 'heavytank', 'heavytank', 'regenerator', 'regenerator'], // 34 (12)
        ['aggro', 'aggro', 'superspeed', 'superspeed', 'aggro', 'aggro', 'superspeed', 'superspeed', 'aggro', 'aggro', 'superspeed', 'superspeed'], // 35 (12)
        ['healer', 'healer', 'heavytank', 'heavytank', 'healer', 'healer', 'heavytank', 'heavytank', 'healer', 'healer', 'heavytank', 'heavytank'], // 36 (12)
        ['superspeed', 'splitter', 'superspeed', 'splitter', 'superspeed', 'splitter', 'superspeed', 'splitter', 'superspeed', 'splitter', 'superspeed', 'splitter'], // 37 (12)
        ['heavytank', 'jumper', 'heavytank', 'jumper', 'heavytank', 'jumper', 'heavytank', 'jumper', 'heavytank', 'jumper', 'heavytank', 'jumper'], // 38 (12)
        ['burning', 'burning', 'superspeed', 'heavytank', 'burning', 'burning', 'superspeed', 'heavytank', 'burning', 'burning', 'superspeed', 'heavytank'], // 39 (12)
        ['aggro', 'healer', 'superspeed', 'heavytank', 'regenerator', 'splitter', 'burning', 'aggro', 'healer', 'superspeed', 'heavytank', 'regenerator'], // 40 (12)
        ['superspeed', 'superspeed', 'superspeed', 'heavytank', 'heavytank', 'superspeed', 'superspeed', 'superspeed', 'heavytank', 'heavytank', 'superspeed', 'superspeed'], // 41 (12)
        ['heavytank', 'heavytank', 'heavytank', 'superspeed', 'superspeed', 'heavytank', 'heavytank', 'heavytank', 'superspeed', 'superspeed', 'heavytank', 'heavytank'], // 42 (12)
        ['burning', 'burning', 'burning', 'aggro', 'aggro', 'burning', 'burning', 'burning', 'aggro', 'aggro', 'burning', 'burning'], // 43 (12)
        ['regenerator', 'regenerator', 'regenerator', 'healer', 'healer', 'regenerator', 'regenerator', 'regenerator', 'healer', 'healer', 'regenerator', 'regenerator'], // 44 (12)
        ['splitter', 'splitter', 'splitter', 'jumper', 'jumper', 'splitter', 'splitter', 'splitter', 'jumper', 'jumper', 'splitter', 'splitter'], // 45 (12)
        ['superspeed', 'heavytank', 'superspeed', 'heavytank', 'superspeed', 'heavytank', 'superspeed', 'heavytank', 'superspeed', 'heavytank', 'superspeed', 'heavytank'], // 46 (12)
        ['aggro', 'burning', 'aggro', 'burning', 'aggro', 'burning', 'aggro', 'burning', 'aggro', 'burning', 'aggro', 'burning'], // 47 (12)
        ['healer', 'regenerator', 'healer', 'regenerator', 'healer', 'regenerator', 'healer', 'regenerator', 'healer', 'regenerator', 'healer', 'regenerator'], // 48 (12)
        ['superspeed', 'heavytank', 'aggro', 'healer', 'burning', 'regenerator', 'splitter', 'jumper', 'stunner', 'transparent', 'basic', 'speedy'], // 49 (12)
        ['heavytank', 'heavytank', 'superspeed', 'superspeed', 'aggro', 'aggro', 'burning', 'burning', 'regenerator', 'regenerator', 'splitter', 'splitter', 'healer', 'healer', 'heavytank', 'superspeed', 'aggro', 'burning', 'regenerator', 'splitter', 'healer', 'tank'] // 50 (22)
    ];
    ...
    function startNextWave() {
        ...
        let waveEnemies = [...waves[wave - 1]]; // Make a mutable copy

        if (isHardMode && wave > 24) {
            const extraEnemiesCount = (wave - 24) * 2; // Wave 25 -> 2 extra, 26 -> 4, etc.
            const lastEnemyType = waveEnemies[waveEnemies.length - 1];
            for (let i = 0; i < extraEnemiesCount; i++) {
                // Add the last enemy type of the wave again
                waveEnemies.push(lastEnemyType);
            }
        }
        ...
        const spawnInterval = setInterval(() => {
            ...
            let healthMultiplier = 1.0; // Default for Normal Mode

            if (isHardMode) {
                if (wave >= 30) {
                    healthMultiplier = 2.0; // On Hard Mode wave 30+, health is 2x
                } else {
                    healthMultiplier = 1.5; // On Hard Mode waves 25-29, health is 1.5x
                }
            }

            newEnemy.health = Math.floor(newEnemy.health * healthMultiplier);
            newEnemy.maxHealth = newEnemy.health;

            enemies.push(newEnemy);
            spawnIndex++;
        }, 350); // Spawn a new enemy every 0.35 seconds
    }
    ...
    function handleProjectiles() {
        for (let i = projectiles.length - 1; i >= 0; i--) {
            ...
            if (p instanceof BombProjectile) {
                    ...
                    for (const enemy of enemies) {
                        ...
                        if (Math.sqrt(dx * dx + dy * dy) < 10) {
                            ...
                            if (enemy.isHeavyTank) {
                                damageToApply = Math.max(0, damageToApply - enemy.damageReduction);
                            }
                ...
                } else { // Standard Non-Piercing Projectile
                    const dx = p.x - p.target.x;
                    const dy = p.y - p.target.y;
                    if (Math.sqrt(dx * dx + dy * dy) < 10) {
                        let damageToApply = p.damage;
                        if (p.target.isHeavyTank) {
                            damageToApply = Math.max(0, damageToApply - p.target.damageReduction);
                        }
    ...
    function showWaveBonusNotification(message) {
        const waveBonusEl = document.getElementById('wave-bonus-notification');
        waveBonusEl.textContent = message;
        waveBonusEl.classList.add('show');
        waveBonusEl.classList.remove('hidden');

        setTimeout(() => {
            waveBonusEl.classList.remove('show');
            // Use another timeout to truly hide it after the fade-out transition
            setTimeout(() => {
                 waveBonusEl.classList.add('hidden');
    ...
    function handleCanvasClick(e) {
        ...
        if (placingUnit) {
            ...
            // Check tower limit
            const maxTowers = isHardMode ? 14 : 8;
    ...
    function gameLoop() {
        ...
        if (!waveSpawning && enemies.length === 0 && wave < waves.length) {
            ...
            // Give currency bonus if not in hard mode and bonus not already given for this wave
            if (wave > 0 && wave < 25 && !waveBonusGiven.includes(wave)) {
                const bonus = wave * 10;
                currency += bonus;
                waveBonusGiven.push(wave);
                showWaveBonusNotification(`${wave} 웨이브 완료! 지원금 +${bonus}`);
                flashElement(currencyEl, 'green');
            }
        }
